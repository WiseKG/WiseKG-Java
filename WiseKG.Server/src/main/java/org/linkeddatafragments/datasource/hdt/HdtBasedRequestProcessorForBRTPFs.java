...
public class HdtBasedRequestProcessorForBRTPFs
            ...
            extends AbstractRequestProcessorForBindingsRestrictedTriplePatterns.Worker<RDFNode,String,String>
    {
        ...
        protected long estimateCardinality(ITriplePatternElement<RDFNode, String, String> subject,
                                           ...
                                           List<Binding> bindings, List<Var> foundVariables) throws IllegalArgumentException {
            ...
            while (it.hasNext()) {
                ...
                numResultEstimation += matches.estimatedNumResults();
            }
        ...
        protected double meanElementSize(ITriplePatternElement<RDFNode, String, String> subj,
                                         ...
                                         ITriplePatternElement<RDFNode, String, String> obj,
            ...
            for(Binding bind : bindings) {
                Iterator<Var> it = bind.vars();
                while(it.hasNext()) {
                    Node node = bind.get(it.next());
                    total += node.getURI().getBytes().length;
                    num++;
                }
            }
...
//         }
            ...
            return new TriplePatternFragmentImpl(triples, estimatedValid, request.getFragmentURL(),
                    request.getDatasetURL(), request.getPageNumber(), isLastPage, triplesAddedInCurrentPage);
        }
