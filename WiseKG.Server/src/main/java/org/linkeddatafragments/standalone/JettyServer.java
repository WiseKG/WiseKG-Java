...
import org.linkeddatafragments.servlet.*;
...
public class JettyServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // add a simple Servlet at "/partition/*"
        ServletHolder holderPartitionExec= new ServletHolder("partition", PartitionFragmentServlet.class);
        holderPartitionExec.setInitParameter(LinkedDataFragmentServlet.CFGFILE, config);
        context.addServlet(holderPartitionExec, "/partition/*");

        // add a simple Servlet at "/cardinality/*"
        ServletHolder holderCardinality= new ServletHolder("plan", QueryExecutionPlanServlet.class);
        holderCardinality.setInitParameter(LinkedDataFragmentServlet.CFGFILE, config);
        context.addServlet(holderCardinality, "/plan/*");
