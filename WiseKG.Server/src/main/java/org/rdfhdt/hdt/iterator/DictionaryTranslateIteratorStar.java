...
import org.linkeddatafragments.datasource.hdt.HdtBasedRequestProcessorForSPFs;
...
public class DictionaryTranslateIteratorStar implements IteratorStarString {
    ...
    public DictionaryTranslateIteratorStar(StarString star, HDT hdt) {
        this(star, new ArrayList<>(), new ArrayList<>(), hdt);
    }
    ...
    public DictionaryTranslateIteratorStar(StarString star, List<Binding> bindings, List<ICharacteristicSet> characteristicSets, HDT hdt) {
        ...
        estimateNumResults(star, bindings, characteristicSets);
    }
